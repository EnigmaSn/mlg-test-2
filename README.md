...
Список и детали
Напишите проект, использующий React Router и Redux Thunk, который удовлетворяет следующим условиям:
...
![loader](./pic/B13CC99F-A588-40A3-BAB3-EDF25B140F3D.png)
...
![reload](./pic/D2446DA8-9A38-46DC-8B11-58846898BCA2.png)

Готовый бэкенд расположен в каталоге [backend](./backend/).
После установки зависимостей запустить команду ```yarn start```.
